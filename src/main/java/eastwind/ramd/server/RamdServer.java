...
import eastwind.ramd.channel.ChannelGroup;
import eastwind.ramd.channel.OutboundChannel;
import eastwind.ramd.channel.TcpChannel;
import eastwind.ramd.model.TcpObject;
import eastwind.ramd.support.RamdUtils;

public class RamdServer extends Server {

	private static Logger LOGGER = LoggerFactory.getLogger(RamdServer.class);
	...
	public RamdServer(String addressStr) {
